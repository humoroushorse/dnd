...
### 0. `cd ~/ttrpg/ttrpg-api/py_event_planning`
### 1. cleanup
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table_schema=schemas.enums.DbSchemaEnum.EVENT_PLANNING.value,  # <-- MATCH THE SCHEMA
        literal_binds=True,
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        schema_name = schemas.enums.DbSchemaEnum.EVENT_PLANNING.value
        context.configure(
