...
def random_source(integration_global_data) -> schemas.SourceCreate:
    ...
    random_source = schemas.SourceCreate(**r_source)
    return random_source


def test_post(client: TestClient, random_source: schemas.SourceCreate) -> None:
...
def test_put(client: TestClient, random_source: schemas.SourceCreate) -> None:
    """Tests put: happy path."""
    random_source_copy = schemas.SourceCreate(**random_source.dict())
...
def test_put_does_not_exist(
    client: TestClient, random_source: schemas.SourceCreate
) -> None:
    """Tests post: 404."""
    random_source_copy = schemas.SourceCreate(**random_source.dict())
...
def test_delete(client: TestClient, random_source: schemas.SourceCreate) -> None:
